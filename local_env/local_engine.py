...
if __name__ == "__main__":
    ...
    # glob_non_iid_noise = add_gaussian_noise(glob_non_iid, columns, noise_level=1.6)
    ...
    # client_1_non_iid_noise = add_gaussian_noise(client_1_non_iid, columns_1, noise_level=1.8)
