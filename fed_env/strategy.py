...
class EarlyStoppingFedAvg(FedAvg):
    ...
    def save_metrics(self, data: List[Dict], filename: str, strategy_suffix: str):
            ...
            all_metrics[strategy_suffix].append(data)

            with open(filename, "w") as f:
                json.dump(all_metrics, f, indent=4)

            logging.info(f"[Server] Metrics successfully saved to '{filename}' under suffix '{strategy_suffix}'.")
